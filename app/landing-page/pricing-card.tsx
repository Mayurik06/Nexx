...
const PricingCard=({title, price,features,description,isPopular,url}:PricingPlan)=>{
    ...
    return(
       <div className="border flex flex-col justify-between bg-white/20 rounded-lg h-full p-6 hover:shadow-md text-left relative">
       {
            ...
            <ul>
                {
                    features.map((feature,index)=>(
                     ...
                     <div className="rounded-full flex items-center justify-center bg-gray-800 w-4 h-4 mr-2">
        ...
        <div>
           <button onClick={onClickBtn} className="bg-gray-900 py-2 mt-3 rounded-lg text-white w-full">
            SelectPlan
           </button>
        </div>
       </div> 
